...
class Solution {
    public int[] frequencySort(int[] nums) {
        ...
        // 2. Convertir int[] a Integer[] porque Arrays.sort con Comparator
        // solo funciona con objetos, no con primitivos
        ...
        // 4. Pasar el resultado de nuevo a nums
